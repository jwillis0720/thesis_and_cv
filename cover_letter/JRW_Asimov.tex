...
\address{}{Kansas City 64153}{USA}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Asimov Team}{Asimov \\Cambridge, MA}
\date{2020}
\opening{Dear Asimov Team}
\closing{Sincerely}
...
I'm very exciting to be applying to the position of Senior Computational Biologist at Asimov. As I have spent the last couple months deeply researching inducible systems, I have come across many papers from the Voigt Lab and was inspired by the creative use of gene circuits. I love the idea of applying deep learning to this problem and I believe this is one of the most exciting research endeavors in modern biological research. 

Considering my background as a computational biologist in the fields of bioinformatics, deep learning and protein engineering, I have much to offer a company like Asimov.
For the past 14 years I have developed diverse skillset that remarkably intersects with the qualifications you seek. In reviewing skills that are important for this position, I have a mastery or proficiency in all the required skills (software engineering, mammalian cell line engineering, and ML algorithms), as well as passion for the early stage startup environment.
...
I also started integrating molecular modeling, protein dynamics and deep learning algorithms to design new functional protein topologies. Recently, I was recruited for a Principal Scientist of protein engineering to develop immunologically silent AAV capsids. I have also been independently developing deep learning algorithms to annotate NGS sequences for B cells as the current method is clunky and computationally intensive.

I'm looking forward to learning more details about the Computational Biologist position at Asimov. I'm very committed individual and have a tremendous amount
 to offer a company like Asimov. I'm extremely hard working and motivated. I'm always eager to learn the latest technology to solve any given scientific problem. 
