...
\usepackage{hyperref}
\hypersetup{
	pdftitle={Development of Novel Methods for Computational Protein Design and Protein-Ligand Docking.},
...
\begin{center}
	{\setstretch{1.66} \MakeUppercase{Development of Novel Methods for Computational Protein Design and Protein-Ligand Docking.}\par }%
	\vskip.5in
	By
	\vskip .4in
	{Sam DeLuca}
