...
Peptide conformations are collected from the PDB for homologous stretches of sequence  \citep{Simons:1997do} which capture the structural bias of the local sequence  \citep{Bystroff:1996vl}.
...
The results of this study indicated that while the conformations of rigid structures typically differed by < 0.1 \AA\ RMSD between the bound and unbound context, flexible ligands typically differed significantly, frequently by several angstroms.
...
Since the publication of the perceptron as a method of machine learning \citep{Rosenblatt:1958jc}, ANNs have become an area of great interest to the machine learning community.
